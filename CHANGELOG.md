# [30.3.0](https://github.com/timothycpoon/xdy-pf2e-workbench/compare/fv30.2.0...fv30.3.0) (2024-01-07)


### Bug Fixes

* Another try ([61e6be3](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/61e6be3cb627e4735d319fe9844895f1008ca824))
* Another try at using ghost's foundry-publish ([939238d](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/939238de889eef36f72aed8d62bf8eabca5e0ebb))
* BAM: Added "Create a Diversion - Distracting Words". Changed Administer First Aid, Create A Diversion, Decipher Writing, Performance, Subsist to use new style actions. Added i18n for Reposition. Cleaned up the code. ([2a2ab48](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/2a2ab487563942de41ee95abbd3bf7acc31278ec)), closes [#1195](https://github.com/timothycpoon/xdy-pf2e-workbench/issues/1195)
* BAM: Improved handling of attack, downtime and exploration traits. ([e891354](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/e89135478cf14f86364930a88510e9be2d3c6541)), closes [#1112](https://github.com/timothycpoon/xdy-pf2e-workbench/issues/1112)
* BAM: Use new-style actions for Disarm, Feint, Gather Information, Grapple, Impersonate, Jump (High), Make an Impression and Shove. ([cc7a526](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/cc7a526db41c0efe35c356ff6326ae656c2b9559))
* Changed the option "Characters automatically drop held items on becoming unconscious." so that items with the trait "free-hand" (e.g. gauntlets) are treated like strapped shields, e.g. they go from held to worn instead of being dropped. ([54777d5](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/54777d57d2232d3cd2cb1f11b56709695c724997)), closes [#1189](https://github.com/timothycpoon/xdy-pf2e-workbench/issues/1189)
* Define ref-name ([064b87e](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/064b87e982302806abb60fec6ed76259370c5ddc))
* Deploy problems part infinity ([8114d54](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/8114d543e2ea660812165eaa970bdb6f41cc8bbd))
* Format yaml ([d48f98b](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/d48f98bafc7a6ef5b86a4715395b093603ce8a17))
* I don't like yaml formatting. :( ([acd9522](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/acd95225e596293aae41bd90dd2c505a41f1e4fe))
* Like this then? ([8b5cc04](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/8b5cc044bbf89623dd355d1f7af1577cf06b4bb2))
* Once more unto the breach... ([f85c013](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/f85c013dcb7d8872396f855b1f55e746898f67bc))
* Or, like this? ([9592ec2](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/9592ec23c59f05b9ee6ac10a0ca6a5b7c13d4859))
* Overcomplicating things... ([1f44986](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/1f4498617edafc846546089237c738112d6a3878))
* package.json ([c7cedda](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/c7ceddaa9b544c630a5a7f87b193af9f3dd9b021))
* Script the version? ([607c5d9](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/607c5d9244ce391d36811c2c15fc1abf99eee55c))
* Stupid typos are stupid... ([cfbd20e](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/cfbd20e92af0a31c00c0146cfb147d75a141be4c))
* Try curl ([3da835a](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/3da835a52bc6b40faa9f6be08609bf799f48ad64))
* Twice more unto the breach... ([15d5343](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/15d5343af970dd3514689fa4bbe8abd65053d800))
* Typo ([c93b43f](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/c93b43f1538836be234022998576d2bebec08e34))
* Use the github variable ([0f2cbee](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/0f2cbee81f2d74428debba2b8c2ce0ae2c4beae1))
* When handling nonlethal damage, check rollOption instead of item trait. ([dfd9597](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/dfd95977cc134e35cd4e9a50dacb1da1d726ed6c))
* Yet another try ([3399962](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/3399962d0ba49e706a80113aa0a397c0ed10b929))


### Features

* Update types, remove use of deprecated methods. Set minimum and verified pf2e to 5.12.0 ([bfe644c](https://github.com/timothycpoon/xdy-pf2e-workbench/commit/bfe644cad0fdc87cec838ebaf1192dec20ef8105)), closes [#1194](https://github.com/timothycpoon/xdy-pf2e-workbench/issues/1194)
